...
export default function Sidebar({
  ...
  return (
    <div className="hidden lg:flex flex-col sticky top-28 h-[calc(100vh-7rem)] w-[18rem] shrink-0 bg-white dark:bg-[#0e0e0f] isolate">
      <nav className="relative lg:text-sm lg:leading-6 flex-1 overflow-y-auto pr-8 pb-10">
        <div className="sticky top-0 h-8 z-5 bg-linear-to-b from-white dark:from-[#0e0e0f]" />
