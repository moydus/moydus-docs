...
> = {
  container: {
    ...
    inactive: 'hover:bg-gray-600/5 dark:hover:bg-white/5 text-gray-700 dark:text-gray-400 hover:text-gray-900 dark:hover:text-gray-100',
  },
  card: {
    base: 'ml-4 border-l outline-offset-[-1px]',
    active: `border-(--primary) bg-(--primary)/10 ${ACTIVE_TEXT}`,
    inactive:
      'border-gray-950/5 dark:border-white/10 hover:bg-gray-600/5 dark:hover:bg-white/5 text-gray-700 dark:text-gray-400 hover:text-gray-900 dark:hover:text-gray-100',
  },
  border: {
    base: 'ml-4 border-l py-2 lg:py-1.5 w-[calc(100%-1rem)]',
    active: `border-(--primary) ${ACTIVE_TEXT}`,
    inactive:
      'border-gray-950/5 dark:border-white/10 hover:border-gray-950/20 dark:hover:border-white/20 text-gray-700 dark:text-gray-400 hover:text-gray-900 dark:hover:text-gray-100',
  },
  undecorated: {
    active: `border-(--primary) ${ACTIVE_TEXT}`,
    inactive:
  ...
  arrow: {
    active: `border-(--primary) ${ACTIVE_TEXT}`,
    inactive:
      'border-gray-950/5 dark:border-white/10 hover:border-gray-950/20 dark:hover:border-white/20 text-gray-700 dark:text-gray-400 hover:text-gray-950 dark:hover:text-gray-100',
  },
  plain: {
    active: ACTIVE_TEXT,
    inactive: 'text-gray-950 dark:text-gray-300 hover:text-(--primary)',
  },
};
  ...
  return (
    <li className="relative scroll-m-4 first:scroll-m-20" data-title={title}>
      ...
      >
        ...
        {page.deprecated && (
          <span className="shrink-0 text-xs font-medium px-2 py-0.5 rounded-md bg-gray-100 dark:bg-white/10 text-gray-600 dark:text-gray-400">
            Deprecated
          </span>
        )}
      </a>
